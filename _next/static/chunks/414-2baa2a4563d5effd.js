      ...
      let P = o.default.forwardRef(function (e, t) {
          ...
          let K = w ? r && "object" == typeof r && r.ref : t,
            ...
            B = o.default.useCallback(
              (e) => {
                (z.current !== W || D.current !== N) &&
                  (q(), (z.current = W), (D.current = N)),
                  F(e),
                  K &&
                    ("function" == typeof K
                      ? K(e)
          ...
          if ((0, i.isAbsoluteUrl)(W)) H.href = W;
            ...
            H.href =
              t ||
              (0, h.addBasePath)(
                (0, f.addLocale)(W, e, null == S ? void 0 : S.defaultLocale)
              );
          }
          return w
            ? o.default.cloneElement(r, H)
            : o.default.createElement("a", { ...k, ...H }, n);
        }),
        v = P;
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        ...
        let i = (0, o.removeTrailingSlash)(e).slice(1).split("/"),
          f =
            ...
            () => {
              let e = "";
              for (let t = 0; t < l; t++)
                (e += String.fromCharCode(n)), ++n > 122 && (l++, (n = 97));
              return e;
            }),
          c = {};
        return {
